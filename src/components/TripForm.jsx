...
export default function TripForm({ onAddTrip, tripToEdit, onSaveEdit, isEditing }) {
      ...
      >
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <Circle className={`h-4 w-4 ${statusColors[tripStatus]}`} fill="currentColor" />
            <select
              value={tripStatus}
        ...
        <div className="col-span-full">
          <label className="text-sm font-medium mb-1 block">Choose a cover image</label>
          <select
            value={selectedCover}
